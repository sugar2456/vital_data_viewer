...
@router.get("/fitbit/calories/{start_date}/{end_date}", response_model=FitbitCaloriesPeriodResponse)
async def fitbit_calories_period(
    ...
    intaked_calories_period = food_service.get_food_calories_period(int(current_user_id), start_date, end_date)
