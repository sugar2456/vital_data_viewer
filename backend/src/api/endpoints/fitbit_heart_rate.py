...
async def fitbit_resting_heart_rate(
    ...
    resting_heart_rate = service.get_resting_heart_rate(current_user_id, date)
...
async def fitbit_heart_rate_intraday(
    ...
    heart_rate_intraday = service.get_heart_rate_intraday(current_user_id, date, detail_level)
